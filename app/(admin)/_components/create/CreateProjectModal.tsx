...
import { createProjectData } from "@/actions/pb";
...
export default function CreateProjectModal({ isOpen, onClose }: NewModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Yeni Proje Ekle (Proje Bölümü)</DialogTitle>
          <DialogDescription>
